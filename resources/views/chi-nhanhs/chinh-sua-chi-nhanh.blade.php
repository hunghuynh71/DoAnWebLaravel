          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" name="tenChiNhanh" class="form-control" value="{{$chi_nhanh->ten_cn}}">
              </div>
              <div class="form-group">
                <label for="diaChi">Địa chỉ</label>
                <input type="text" name="diaChi" class="form-control" value="{{$chi_nhanh->dia_chi}}">
              </div>
              <div class="form-group">
                <label for="sdt">SĐT</label>
                <input type="text" name="sdt" class="form-control" value="{{$chi_nhanh->sdt}}">
              </div>
              <div class="form-group">
                <label for="hinhAnh">Hình ảnh</label>
                <input type="file" name="hinhAnh" class="form-control" value="{{$chi_nhanh->hinh_anh}}">
              </div>
            </div>
            <!-- /.card-body -->
            <div class="card-footer">
              <a href="{{route('chi-nhanh.getChiNhanhs')}}" class="btn btn-secondary">Thoát</a>
              <input type="submit" value="Chỉnh sửa chi nhánh" class="btn btn-success float-right">
            </div>
            <!-- /.card-footer -->
