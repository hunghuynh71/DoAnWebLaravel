      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Chỉnh sửa đạo diễn</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" name="tenDaoDien" class="form-control" value="{{$dao_dien->ten_dd}}">
              </div>
              <div class="form-group">
                <label for="ngaySinh">Địa chỉ</label>
                <input type="date" name="ngaySinh" class="form-control" value="{{$dao_dien->ngay_sinh}}">
              </div>
              <div class="form-group">
                <label for="chieuCao">Chiều cao</label>
                <input type="text" name="chieuCao" class="form-control" value="{{$dao_dien->chieu_cao}}">
              </div>
              <div class="form-group">
                <label for="quocGia">Quốc gia</label>
                <input type="text" name="quocGia" class="form-control" value="{{$dao_dien->quoc_gia}}">
              </div>
              <div class="form-group">
                <label for="tieuSu">Tiểu sử</label>
                <input type="text" name="tieuSu" class="form-control" value="{{$dao_dien->tieu_su}}">
              </div>
              <div class="form-group">
                <label for="hinhAnh">Hình ảnh</label>
                <input type="file" name="hinhAnh" class="form-control" value="{{$dao_dien->hinh_anh}}">
              </div>
            </div>
            <!-- /.card-body -->
            <div class="card-footer">
              <a href="{{route('dao-dien.getDaoDiens')}}" class="btn btn-secondary">Thoát</a>
              <input type="submit" value="Chỉnh sửa đạo diễn" class="btn btn-success float-right">
            </div>
            <!-- /.card-footer -->
