...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Chi tiết diễn viên</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('trang-chu')}}">Trang chủ</a></li>
            <li class="breadcrumb-item active">Chi tiết diễn viên</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-12 col-md-12 col-lg-12 order-12 order-md-12">
            <h1 class="text-primary text-center">{{$dien_vien->ten_dv}}</h1>
            <p>Ngày sinh: {{$dien_vien->ngay_sinh}}</p>
            <p>Chiều cao: {{$dien_vien->chieu_cao}}</p>
            <p>Quốc gia: {{$dien_vien->quoc_gia}}</p>
            <p>Tiểu sử: {{$dien_vien->tieu_su}}</p>
            <p>Hình ảnh: {{$dien_vien->hinh_anh}}</p>
            <div class="text-center mt-5 mb-3">
              <a href="{{route('dien-vien.editDienVien',$dien_vien->id)}}" class="btn btn-sm btn-primary">Chỉnh sửa</a>
              <a href="{{route('dien-vien.getDienViens')}}" class="btn btn-sm btn-warning">Thoát</a>
            </div>
          </div>
        </div>
      </div>
