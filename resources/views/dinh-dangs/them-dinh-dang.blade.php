          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" name="tenDinhDang" class="form-control">
              </div>
            </div>
            <!-- /.card-body -->
            <div class="card-footer">
              <a href="{{route('dinh-dang.getDinhDangs')}}" class="btn btn-secondary">Thoát</a>
              <input type="submit" value="Thêm định dạng" class="btn btn-success float-right">
            </div>
            <!-- /.card-footer -->
