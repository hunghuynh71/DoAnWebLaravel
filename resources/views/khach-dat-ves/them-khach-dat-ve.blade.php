...
@section('title','Thêm khách đặt vé')
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Thêm khách đặt vé</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('trang-chu')}}">Trang chủ</a></li>
            <li class="breadcrumb-item active">Thêm khách đặt vé</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" name="tenKhachDatVe" class="form-control">
              </div>
              <div class="form-group">
            ...
            <div class="card-footer">
              ...
              <input type="submit" value="Thêm khách đặt vé" class="btn btn-success float-right">
            </div>
            <!-- /.card-footer -->
