...
@section('title','Thêm khung thời gian chiếu')
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Thêm khung thời gian chiếu</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('trang-chu')}}">Trang chủ</a></li>
            <li class="breadcrumb-item active">Thêm khung thời gian chiếu</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
        ...
        <form method="post" action="">
          ...
          <div class="card card-primary">
            ...
            <div class="card-footer">
              <a href="{{route('khung-tg-chieu.getKhungTGChieus')}}" class="btn btn-secondary">Thoát</a>
              <input type="submit" value="Thêm khung thời gian chiếu" class="btn btn-success float-right">
            </div>
            <!-- /.card-footer -->
