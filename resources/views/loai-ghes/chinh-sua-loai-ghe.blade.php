...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Chỉnh sửa loại ghế</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('trang-chu')}}">Trang chủ</a></li>
            <li class="breadcrumb-item active">Chỉnh sửa loại ghế</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" name="tenLoaiGhe" class="form-control" value="{{$loai_ghe->ten_lg}}">
              </div>
            </div>
            <!-- /.card-body -->
            <div class="card-footer">
              <a href="{{route('loai-ghe.getLoaiGhes')}}" class="btn btn-secondary">Thoát</a>
              <input type="submit" value="Chỉnh sửa loại ghế" class="btn btn-success float-right">
            </div>
            <!-- /.card-footer -->
