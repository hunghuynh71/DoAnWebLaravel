...
@section('title','Chi tiết rạp phim')
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Chi tiết rạp phim</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('trang-chu')}}">Trang chủ</a></li>
            <li class="breadcrumb-item active">Chi tiết rạp phim</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Thông tin rạp phim</h3>
        ...
        <div class="row">
          <div class="col-12 col-md-12 col-lg-12 order-12 order-md-12">
            ...
            <div class="text-center mt-5 mb-3">
              ...
              <a href="{{route('rap-phim.getRapPhims')}}" class="btn btn-sm btn-warning">Thoát</a>
            </div>
          </div>
        </div>
      </div>
