      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Chỉnh sửa rạp phim</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" name="tenRapPhim" class="form-control" value="{{$rap_phim->ten_rap}}">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="number" name="soGhe" class="form-control" value="{{$rap_phim->so_ghe}}">
              </div>
            </div>
            <!-- /.card-body -->
            <div class="card-footer">
              <a href="{{route('rap-phim.getRapPhims')}}" class="btn btn-secondary">Thoát</a>
              <input type="submit" value="Chỉnh sửa rạp phim" class="btn btn-success float-right">
            </div>
            <!-- /.card-footer -->
