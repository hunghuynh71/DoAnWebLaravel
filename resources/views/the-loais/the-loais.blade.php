  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <a class="btn btn-success btn-sm" href="{{url('the-loai/them-the-loai')}}">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="project-actions text-right">
                <a class="btn btn-info btn-sm" href="{{route('the-loai.editTheLoai',$the_loais[$p]->id)}}">
                  <i class="fas fa-pencil-alt">
                  </i>
                  Sửa
                </a>
                <a class="btn btn-danger btn-sm" href="{{route('the-loai.deleteTheLoai',$the_loais[$p]->id)}}">
