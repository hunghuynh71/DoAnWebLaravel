      ...
      <div class="card-body login-card-body">
        ...
        <form action="" method="post">
          ...
          <div class="input-group mb-3">
            <input name="maXacNhan" type="text" class="form-control" placeholder="Nhập mã xác nhận">
          ...
          <div class="row">
            <div class="col-12">
              <button type="submit" class="btn btn-primary btn-block">Xác nhận tài khoản</button>
            </div>
            <!-- /.col -->
          </div>
        </form>
        ...
        <p class="mt-3 mb-1">
          <a href="{{route('quen-mat-khau')}}">Thoát</a>
        </p>
      </div>
      <!-- /.login-card-body -->
    </div>
